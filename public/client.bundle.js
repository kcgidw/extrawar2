...
socket.on(SOCKET_MESSAGES.LOBBY_NUM_ONLINE, (data) => {
    console.log(data.count + ' users online');
});
socket.emit(SOCKET_MESSAGES.LOBBY_CREATE_USER, { username: '123abc' });
socket.on(SOCKET_MESSAGES.LOBBY_CREATE_USER, (data) => {
    console.log(data);
});
